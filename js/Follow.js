(() => {
  ...
  function getPreservedRows(){
    return [...followMonitors.values()].map(t=>t.rowSnapshot).filter(r=>r&&typeof r.symbol==='string');
  }
  ...
  window.CryptoFlowScanner.modules.follow={config:FOLLOW_CONFIG,liveConfig:FOLLOW_LIVE_CONFIG,getPreservedRows,syncUI:syncFollowUI,stopAll:stopAllFollowMonitors};
})();
