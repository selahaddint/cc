(() => {
  ...
  function getPreservedRows(){
    return [...followMonitors.values()]
      .filter(t=>t&&t.status!=='RED')
      .map(t=>t.rowSnapshot)
  ...
  window.CryptoFlowScanner.modules.follow={config:FOLLOW_CONFIG,liveConfig:FOLLOW_LIVE_CONFIG,getPreservedRows,syncUI:syncFollowUI,purgeExited:purgeExitedFollowMonitors,stopAll:stopAllFollowMonitors};
})();
