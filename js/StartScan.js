(() => {
  ...
  function preservedFollowRows(){
    const rows=followModule()?.getPreservedRows?.();
  ...
  window.CryptoFlowScanner.modules.startScan={config:V2_CONFIG,priceConfig:PRICE_CONFIG,state,autoScan:{intervalMs:AUTO_SCAN_INTERVAL_MS,schedule:scheduleAutoScan,cancel:clearAutoScanTimer}};
})();
